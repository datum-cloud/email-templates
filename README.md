...
<details>
<summary><strong>Project Suspension Deletion Warning</strong> — a clear warning that a suspended project is on the clock and will be deleted if nothing changes <em>(click to preview)</em></summary>

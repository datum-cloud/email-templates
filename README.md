...
<details>
<summary><strong>Email Verification</strong> — a quick nudge to confirm a new user's email address and finish setting up their account <em>(click to preview)</em></summary>

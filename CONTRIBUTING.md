...
If you just need wording or content changed on an existing email and aren't comfortable opening a PR, open a "Content / Wording Change Request" issue instead (Issues → New issue) — see [#63](https://github.com/datum-cloud/email-templates/issues/63) for a filled-out example and [#71](https://github.com/datum-cloud/email-templates/pull/71) for the resulting draft PR. Need a brand-new email entirely? Use the "New Email Template Request" issue form instead — same idea, no coding required; see [#64](https://github.com/datum-cloud/email-templates/issues/64) and its draft PR [#72](https://github.com/datum-cloud/email-templates/pull/72).
